...
update employees
set hourly_pay = hourly_pay + 1;          -- I. Have. Been. Doing. This. For. 40. MINUTES. I. Am. Going. To. EXPLODE.
...
update employees
set hourly_pay = (hourly_pay * 0.25) + hourly_pay
where employee_id = 5;
...
values ("Karen", "Plankton", 19.50, current_date());
...
insert into employees (first_name, last_name, hourly_pay, hire_date)
values ("Pearl", "Krabs", 10.17, current_date());
